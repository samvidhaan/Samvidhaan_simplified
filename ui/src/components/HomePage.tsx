    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="absolute top-0 right-0 w-40 h-40 bg-white opacity-10 rounded-full -mr-20 -mt-20 group-hover:scale-150 transition-transform duration-500" />
            <div className="relative z-10">
              ...
              <p className="text-orange-100 mb-6">
                Challenge yourself with interactive quizzes about the Constitution
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-green-100 mb-6">
                Get instant answers to your questions about the Constitution
              </p>
              <div className="flex items-center space-x-2">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Journey of India&apos;s Constitution
              </p>
            </button>
